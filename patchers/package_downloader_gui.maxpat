...
, 			{
				"box" : 				{
					...
					"bgoncolor" : [ 0.30373, 0.310573, 0.325784, 1.0 ],
					"bgovercolor" : [ 0.399407, 0.399407, 0.399407, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-4",
					"maxclass" : "textbutton",
					...
					"text" : "Refresh",
					"textcolor" : [ 0.960652, 0.960652, 0.960652, 1.0 ],
					"textoncolor" : [ 0.758694, 0.874969, 0.887425, 1.0 ],
					"textovercolor" : [ 0.956632, 0.956632, 0.956632, 1.0 ],
					"textoveroncolor" : [ 0.767109, 0.834153, 0.354403, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.5, 114.0, 77.0, 18.0 ],
					"text" : "ignoreclick 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.75, 141.0, 77.0, 18.0 ],
					"text" : "ignoreclick 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.5, 83.0, 52.0, 18.0 ],
					"text" : "active 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.5, 52.0, 77.0, 20.0 ],
					"text" : "r mpd_unzip"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.75, 114.0, 52.0, 18.0 ],
					"text" : "active 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 200.0, 261.0, 18.0 ],
									"text" : "This package is not supported on your platform"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 227.0, 186.0, 20.0 ],
									"text" : "print \"Max Package Downloader\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 217.5, 142.0, 24.0, 20.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 217.5, 173.0, 52.0, 18.0 ],
									"text" : "active 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 84.5, 155.0, 52.0, 18.0 ],
									"text" : "active 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 84.5, 129.0, 58.0, 20.0 ],
									"text" : "sel None"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 84.5, 100.0, 88.0, 20.0 ],
									"text" : "r mpd_link_zip"
								}
...
,
					"patching_rect" : [ 411.0, 83.0, 117.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 141.0, 233.0, 24.0, 20.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 207.0, 130.0, 20.0 ],
					"text" : "r mpd_package_name"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 233.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 207.0, 95.0, 20.0 ],
					"text" : "r mpd_progress"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 168.0, 101.0, 20.0 ],
					"text" : "s mpd_download"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 141.0, 132.0, 20.0 ],
					"text" : "s mpd_package_menu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 83.0, 78.0, 20.0 ],
					"text" : "r mpd_menu"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-13" : [ "multislider", "multislider", 0 ]
		}
,
		"dependency_cache" : [ 			{
